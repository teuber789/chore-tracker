...
CREATE TABLE IF NOT EXISTS child (
    ...
    created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
    CONSTRAINT fk_child_family_id FOREIGN KEY(family_id) REFERENCES family(id)
);
...
CREATE TABLE IF NOT EXISTS chore (
    ...
    created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
    CONSTRAINT fk_chore_family_id FOREIGN KEY(family_id) REFERENCES family(id)
);
...
CREATE TABLE IF NOT EXISTS chore_completion (
    ...
    created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
    CONSTRAINT fk_chore_completion_family_id FOREIGN KEY(family_id) REFERENCES family(id),
